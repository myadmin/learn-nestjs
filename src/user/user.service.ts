...
export class UserService {
    ...
    async initData() {
        ...
        user1.nickName = '张三';
        user1.isAdmin = true;
        user1.phoneNumber = '13212345678';

        const user2 = new User();
        user2.username = 'lisi';
        user2.password = md5('123456');
        user2.email = 'lisi@test.com';
        user2.nickName = '李四';
    ...
    async login2(loginUserDto: LoginUserDto, userInfo: User) {
        if (userInfo.password !== md5(loginUserDto.password)) {
            throw new HttpException('密码错误', HttpStatus.BAD_REQUEST);
        }
